...
@Singleton
public class HclScopeGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StateMachineElements extends AbstractParserRuleElementFinder {
		...
		//StateMachine:
		//	"statemachine" name=ID "{" ("state" states+=State ("," states+=State)* ";")*
		//	initialtransition=InitialTransition? ("junction" junction+=Junction ("," junction+=Junction)* ";")* ("choice"
		//	choice+=Choice ("," choice+=Choice)* ";")*
		//	transition+=Transition*
		//	"}" ";";
		@Override public ParserRule getRule() { return rule; }
		
		//"statemachine" name=ID "{" ("state" states+=State ("," states+=State)* ";")* initialtransition=InitialTransition?
		//("junction" junction+=Junction ("," junction+=Junction)* ";")* ("choice" choice+=Choice ("," choice+=Choice)* ";")*
		//transition+=Transition* "}" ";"
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		...
		//State:
		//	name=ID ("{"
		//	internaltransition+=InternalTransition* ("entry" "{" entryaction+=EntryAction "}" ";")? ("exit" "{"
		//	exitaction+=ExitAction "}" ";")? ("entrypoint" entrypoint+=EntryPoint ("," entrypoint+=EntryPoint)* ";")* ("exitpoint"
		//	exitpoint+=ExitPoint ("," exitpoint+=ExitPoint)* ";")* ("state" states+=State ("," states+=State)* ";")*
		//	//(history+=History ";")?
		//	initialtransition=InitialTransition? ("junction" junction+=Junction ("," junction+=Junction)* ";")* ("choice"
		//	choice+=Choice ("," choice+=Choice)* ";")* (transition+=Transition | historytransition+=HistoryTransition)*
		//	"}")?;
		@Override public ParserRule getRule() { return rule; }
		
		//name=ID ("{" internaltransition+=InternalTransition* ("entry" "{" entryaction+=EntryAction "}" ";")? ("exit" "{"
		//exitaction+=ExitAction "}" ";")? ("entrypoint" entrypoint+=EntryPoint ("," entrypoint+=EntryPoint)* ";")* ("exitpoint"
		//exitpoint+=ExitPoint ("," exitpoint+=ExitPoint)* ";")* ("state" states+=State ("," states+=State)* ";")* //(history+=History ";")?
		//initialtransition=InitialTransition? ("junction" junction+=Junction ("," junction+=Junction)* ";")* ("choice"
		//choice+=Choice ("," choice+=Choice)* ";")* (transition+=Transition | historytransition+=HistoryTransition)* "}")?
		public Group getGroup() { return cGroup; }
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		...
		//Transition:
		//	"transition" name=(ID | STRING)? ":" from=[Vertex|QualifiedName] "->" to=[Vertex|QualifiedName]
		//	transitionbody=TransitionBody ";";
		@Override public ParserRule getRule() { return rule; }
	...
	public class HistoryTransitionElements extends AbstractParserRuleElementFinder {
		...
		//HistoryTransition:
		//	"historytransition" (name=(ID | STRING) ":")? from=[Vertex|QualifiedName] "->" to=DeepHistory
		//	transitionbody=TransitionBody ";";
		@Override public ParserRule getRule() { return rule; }
	...
	public class TransitionBodyElements extends AbstractParserRuleElementFinder {
		...
		//	transitionoperation=TransitionOperation? ("," (methodparameter+=MethodParameterTrigger | portevent+=PortEventTrigger |
		//	trigger+=Trigger)?
		//	transitionguard=TransitionGuard?
		...
		//{TransitionBody} ("on" (methodparameter+=MethodParameterTrigger | portevent+=PortEventTrigger | trigger+=Trigger |
		//"*"))? transitionguard=TransitionGuard? transitionoperation=TransitionOperation? (","
