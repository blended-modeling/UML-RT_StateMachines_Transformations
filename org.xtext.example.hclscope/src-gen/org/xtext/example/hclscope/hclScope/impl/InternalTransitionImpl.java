 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.hclscope.hclScope.impl.InternalTransitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.hclscope.hclScope.impl.InternalTransitionImpl#getTransitionbody <em>Transitionbody</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalTransitionImpl extends MinimalEObjectImpl.Container implements InternalTransition
{
  ...
  {
    return HclScopePackage.Literals.INTERNAL_TRANSITION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HclScopePackage.INTERNAL_TRANSITION__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetTransitionbody(TransitionBody newTransitionbody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HclScopePackage.INTERNAL_TRANSITION__TRANSITIONBODY, oldTransitionbody, newTransitionbody);
  ...
  public void setTransitionbody(TransitionBody newTransitionbody)
  {
    if (newTransitionbody != transitionbody)
    {
      ...
      if (transitionbody != null)
        msgs = ((InternalEObject)transitionbody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HclScopePackage.INTERNAL_TRANSITION__TRANSITIONBODY, null, msgs);
      if (newTransitionbody != null)
        msgs = ((InternalEObject)newTransitionbody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HclScopePackage.INTERNAL_TRANSITION__TRANSITIONBODY, null, msgs);
      msgs = basicSetTransitionbody(newTransitionbody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HclScopePackage.INTERNAL_TRANSITION__TRANSITIONBODY, newTransitionbody, newTransitionbody));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HclScopePackage.INTERNAL_TRANSITION__TRANSITIONBODY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HclScopePackage.INTERNAL_TRANSITION__NAME:
        return getName();
      case HclScopePackage.INTERNAL_TRANSITION__TRANSITIONBODY:
