...
/**
 * Test suite for default naming and default kind of capsule-parts in capsules.
 */
@PluginResource("resource/party.di")
public class CapsulePartDefaultNameAndKindTest extends AbstractPapyrusTest {
	@ClassRule
	 ...
	 * Initializes me.
	 */
	public CapsulePartDefaultNameAndKindTest() {
		super();
	}
	...
	/**
	 * Verify the default kind of capsule-part ( fixed for no cycle completion and optional for cycle completion)
	 */
	@Test
	public void defaultCapsulePartKindTest() throws Exception {

		Property guest = createCapsulePart(partyCapsule, guestCapsule);
		// if no cycle, the default kind is Fixed
		assertEquals("Capsule part default kind should be fixed", UMLRTCapsulePart.getInstance(guest).getKind(), UMLRTCapsulePartKind.FIXED);

		// simulate a cycle, create a party capsule part in the Guest Capsule
		Property party = createCapsulePart(guestCapsule, partyCapsule);
		// there is a cycle, the default kind should be optional
		assertEquals("Capsule part that complete a cycle should be optional", UMLRTCapsulePart.getInstance(party).getKind(), UMLRTCapsulePartKind.OPTIONAL);
