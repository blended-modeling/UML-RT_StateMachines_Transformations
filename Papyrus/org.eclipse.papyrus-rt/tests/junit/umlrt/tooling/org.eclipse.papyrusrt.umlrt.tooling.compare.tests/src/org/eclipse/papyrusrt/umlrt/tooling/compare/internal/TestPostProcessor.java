...
/**
 * This provides a post processor to add a copy of the first scanned match at
 * the same level of the comparison.
 * <p>
 * This is a copy of
 * org.eclipse.emf.compare.tests.postprocess.data.TestPostProcessor and should
 * be removed, once we have a p2 repo that exposes the test plug-ins of EMF
 * Compare.
 * </p>
 * 
