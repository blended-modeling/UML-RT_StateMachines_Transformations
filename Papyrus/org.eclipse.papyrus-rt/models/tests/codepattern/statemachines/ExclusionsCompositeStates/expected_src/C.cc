...
bool Capsule_C::guard_____State4__ta41( const UMLRTMessage * msg )
{
    #define data ( *(const int64_t * )msg->getParam( 0 ) )
    #define rtdata ( (const int64_t * )msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ExclusionsCompositeStates/ExclusionsCompositeStates.uml ExclusionsCompositeStates::C::State4 guard State4::as4cp1,State4::State1 */
...
bool Capsule_C::guard_____State4__ta42( const UMLRTMessage * msg )
{
    #define data ( *(const int64_t * )msg->getParam( 0 ) )
    #define rtdata ( (const int64_t * )msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ExclusionsCompositeStates/ExclusionsCompositeStates.uml ExclusionsCompositeStates::C::State4 guard State4::as4cp1,State4::State2 */
    return data >= 10;
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
    #undef data
...
void Capsule_C::actionchain_____State3__new_transition_2_to_unvisited_boundary( const UMLRTMessage * msg )
{
    update_state( State3__boundary );
}

void Capsule_C::actionchain_____State3__new_transition_3_to_visited_boundary( const UMLRTMessage * msg )
{
    update_state( State3__boundary );
}

void Capsule_C::actionchain_____State3__tb30( const UMLRTMessage * msg )
{
    update_state( State3__State1 );
}

void Capsule_C::actionchain_____State3__tc31( const UMLRTMessage * msg )
{
    update_state( State3 );
}
...
void Capsule_C::actionchain_____State4__new_transition_6_to_unvisited_boundary( const UMLRTMessage * msg )
{
    update_state( State4__boundary );
}

void Capsule_C::actionchain_____State4__new_transition_7_to_visited_boundary( const UMLRTMessage * msg )
{
    update_state( State4__boundary );
}

void Capsule_C::actionchain_____State4__ta41( const UMLRTMessage * msg )
{
    update_state( State4__State1 );
}

void Capsule_C::actionchain_____State4__ta42( const UMLRTMessage * msg )
{
    update_state( State4__State2 );
    entryaction_____State4__State2( msg );
}

void Capsule_C::actionchain_____State4__tb42( const UMLRTMessage * msg )
{
    update_state( State4 );
    save_history( State4, State4__State2 );
}

void Capsule_C::actionchain_____ta0( const UMLRTMessage * msg )
{
    update_state( State1 );
}

void Capsule_C::actionchain_____ta1( const UMLRTMessage * msg )
{
    update_state( SPECIAL_INTERNAL_STATE_TOP );
    update_state( State2 );
}

void Capsule_C::actionchain_____ta2( const UMLRTMessage * msg )
{
    update_state( SPECIAL_INTERNAL_STATE_TOP );
    update_state( State3 );
}

void Capsule_C::actionchain_____ta3( const UMLRTMessage * msg )
{
    update_state( SPECIAL_INTERNAL_STATE_TOP );
    update_state( State4 );
}

void Capsule_C::actionchain_____tb4( const UMLRTMessage * msg )
{
    update_state( SPECIAL_INTERNAL_STATE_TOP );
    update_state( State5 );
}

Capsule_C::State Capsule_C::junction_____State3__bs3ep1( const UMLRTMessage * msg )
{
    actionchain_____State3__tb30( msg );
    return State3__State1;
}

Capsule_C::State Capsule_C::junction_____State4__as4enp1( const UMLRTMessage * msg )
{
    return choice_____State4__as4cp1( msg );
}

Capsule_C::State Capsule_C::junction_____State4__bs4exp1( const UMLRTMessage * msg )
{
...
Capsule_C::State Capsule_C::choice_____State4__as4cp1( const UMLRTMessage * msg )
{
...
Capsule_C::State Capsule_C::state_____State3__State1( const UMLRTMessage * msg )
{
    ...
    case port_p:
        ...
        case Protocol1::signal_m5:
            actionchain_____State3__tc31( msg );
