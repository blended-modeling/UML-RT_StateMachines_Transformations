...
void Capsule_Ponger::entryaction_____Playing( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/StateMachineInheritance/StateMachineInheritance.uml PingPong::Ponger::Playing entry  */
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/StateMachineInheritance/StateMachineInheritance.uml PingPong::Ponger transition Playing,Playing,ping:pongPort */
