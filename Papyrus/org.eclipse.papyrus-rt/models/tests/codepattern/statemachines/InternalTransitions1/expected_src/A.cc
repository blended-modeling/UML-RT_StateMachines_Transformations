...
void Capsule_A::transitionaction_____State1__it1( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/InternalTransitions1/InternalTransitions1.uml InternalTransitions1::A::State1 transition State1,State1,im1:p */
    log.log("it1");
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/InternalTransitions1/InternalTransitions1.uml InternalTransitions1::A::State1 transition State1,State1,im2:p */
    log.log("it2");
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
void Capsule_A::actionchain_____State1__new_transition_3_to_unvisited_boundary( const UMLRTMessage * msg )
{
    update_state( State1__boundary );
}

void Capsule_A::actionchain_____State1__new_transition_4_to_visited_boundary( const UMLRTMessage * msg )
{
    update_state( State1__boundary );
}
...
Capsule_A::State Capsule_A::state_____State1__boundary( const UMLRTMessage * msg )
{
    switch( msg->destPort->role()->id )
    {
    case port_p:
