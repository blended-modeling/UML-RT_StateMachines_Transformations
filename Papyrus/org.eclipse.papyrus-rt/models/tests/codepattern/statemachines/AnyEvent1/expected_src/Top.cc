...
{
    UMLRTFrameService::connectPorts( &slot->parts[Capsule_Top::part_capsule1].slots[0]->ports[Capsule_Capsule1::borderport_port1], 0, &slot->parts[Capsule_Top::part_capsule2].slots[0]->ports[Capsule_Capsule2::borderport_port1], 0 );
