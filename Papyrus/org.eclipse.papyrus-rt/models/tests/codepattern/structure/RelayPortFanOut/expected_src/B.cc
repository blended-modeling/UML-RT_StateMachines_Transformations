...
void Capsule_B::bindPort( bool isBorder, int portId, int index )
{
    if( isBorder )
        ...
        case borderport_q:
            ...
            {
            case 0:
                UMLRTFrameService::connectRelayPort( borderPorts[borderport_q], index, &slot->parts[part_c].slots[0]->ports[Capsule_C::borderport_r], 0 );
                UMLRTFrameService::bindSubcapsulePort( true, slot->parts[part_c].slots[0]->capsule, portId, index );
                break;
            case 1:
                UMLRTFrameService::connectRelayPort( borderPorts[borderport_q], index, &slot->parts[part_d].slots[0]->ports[Capsule_D::borderport_s], 0 );
...
{
    UMLRTFrameService::connectRelayPort( borderPorts[Capsule_B::borderport_q], 0, &slot->parts[Capsule_B::part_c].slots[0]->ports[Capsule_C::borderport_r], 0 );
    UMLRTFrameService::connectRelayPort( borderPorts[Capsule_B::borderport_q], 1, &slot->parts[Capsule_B::part_d].slots[0]->ports[Capsule_D::borderport_s], 0 );
