...
{
    UMLRTFrameService::connectPorts( &slot->parts[Capsule_Top::part_a].slots[0]->ports[Capsule_A::borderport_p], 0, &slot->parts[Capsule_Top::part_b].slots[0]->ports[Capsule_B::borderport_q], 0 );
    UMLRTFrameService::connectPorts( &slot->parts[Capsule_Top::part_a].slots[0]->ports[Capsule_A::borderport_p], 1, &slot->parts[Capsule_Top::part_b].slots[0]->ports[Capsule_B::borderport_q], 1 );
