...
static UMLRTCommsPortFarEnd borderfarEndList_Top_a_e[] = 
{
    {
        0,
...
UMLRTCommsPort borderports_Top_a_e[] = 
{
    {
        &E,
        Capsule_E::borderport_p,
        &Top_slots[InstId_Top_a_e],
        1,
        borderfarEndList_Top_a_e,
        NULL,
        NULL,
        "",
        true,
...
static UMLRTCommsPortFarEnd borderfarEndList_Top_b[] = 
{
    {
        0,
        &borderports_Top_a_e[Capsule_E::borderport_p]
    }
};
