...
void Capsule_B::entryaction_____State1( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/IncarnateCapsuleWithSubstructure/IncarnateCapsuleWithSubstructure.uml IncarnateCapsuleWithSubstructure::B::State1 entry  */
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/IncarnateCapsuleWithSubstructure/IncarnateCapsuleWithSubstructure.uml IncarnateCapsuleWithSubstructure::B::State2 entry  */
    log.log(LFCAPINST_STATE, "entry");
    q.n().send();
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/IncarnateCapsuleWithSubstructure/IncarnateCapsuleWithSubstructure.uml IncarnateCapsuleWithSubstructure::B transition State1,State2,m:p */
    log.log(LFCAPINST_STATE, "m received at p");
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
