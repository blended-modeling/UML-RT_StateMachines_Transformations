...
void Capsule_Pinger::entryaction_____Playing( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPong/PingPong.uml PingPong::Pinger::Playing entry  */
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPong/PingPong.uml PingPong::Pinger transition Playing,Playing,pong:pingPort */
