...
{
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ServicePorts/ServicePorts.uml ServicePorts::TimingUtil operation getDelayFromCmdLine */
...
{
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ServicePorts/ServicePorts.uml ServicePorts::TimingUtil operation currTimeStr */
