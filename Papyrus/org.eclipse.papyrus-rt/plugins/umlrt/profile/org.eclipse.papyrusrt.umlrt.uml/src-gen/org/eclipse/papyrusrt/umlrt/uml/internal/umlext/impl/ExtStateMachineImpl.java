 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrusrt.umlrt.uml.internal.umlext.impl.ExtStateMachineImpl#getImplicitOwnedMembers <em>Implicit Owned Member</em>}</li>
 *   <li>{@link org.eclipse.papyrusrt.umlrt.uml.internal.umlext.impl.ExtStateMachineImpl#getImplicitRegions <em>Implicit Region</em>}</li>
 *   <li>{@link org.eclipse.papyrusrt.umlrt.uml.internal.umlext.impl.ExtStateMachineImpl#getImplicitConnectionPoints <em>Implicit Connection Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtStateMachineImpl extends ExtNamespaceImpl implements ExtStateMachine {
	/**
	...
	protected EClass eStaticClass() {
		return ExtUMLExtPackage.Literals.STATE_MACHINE;
	}
		...
		if (cache != null) {
			...
			if (implicitOwnedMembers == null) {
				cache.put(eResource, this, ExtUMLExtPackage.Literals.NAMESPACE__IMPLICIT_OWNED_MEMBER,
						implicitOwnedMembers = new DerivedUnionEObjectEList<>(NamedElement.class, this, ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_OWNED_MEMBER, IMPLICIT_OWNED_MEMBER_ESUBSETS));
			}
			return implicitOwnedMembers;
		}
		return new DerivedUnionEObjectEList<>(NamedElement.class, this, ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_OWNED_MEMBER, IMPLICIT_OWNED_MEMBER_ESUBSETS);
	}
	 ...
	 * @ordered
	 */
	protected static final int[] IMPLICIT_OWNED_MEMBER_ESUBSETS = new int[] { ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_OWNED_RULE, ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_REGION, ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_CONNECTION_POINT };
	...
	public EList<Region> getImplicitRegions() {
		if (implicitRegions == null) {
			implicitRegions = new ExtEObjectContainmentEList<>(Region.class, this, ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_REGION);
		}
	...
	public EList<Pseudostate> getImplicitConnectionPoints() {
		if (implicitConnectionPoints == null) {
			implicitConnectionPoints = new ExtEObjectContainmentEList<>(Pseudostate.class, this, ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_CONNECTION_POINT);
		}
	...
	public boolean isSetImplicitOwnedMembers() {
		return super.isSetImplicitOwnedMembers()
				|| eIsSet(ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_REGION)
				|| eIsSet(ExtUMLExtPackage.STATE_MACHINE__IMPLICIT_CONNECTION_POINT);
	}
