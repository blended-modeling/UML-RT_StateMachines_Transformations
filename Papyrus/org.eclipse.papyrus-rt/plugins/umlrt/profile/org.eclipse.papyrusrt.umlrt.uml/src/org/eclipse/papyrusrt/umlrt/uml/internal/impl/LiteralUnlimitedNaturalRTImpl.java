...
/**
 * UML-RT semantics for {@link LiteralUnlimitedNatural}.
 */
public class LiteralUnlimitedNaturalRTImpl extends org.eclipse.uml2.uml.internal.impl.LiteralUnlimitedNaturalImpl implements InternalUMLRTValueSpecification {
	...
	public LiteralUnlimitedNaturalRTImpl() {
		super();
	}
	...
	public <T> T umlGet(int featureID) {
		switch (featureID) {
		case UMLPackage.LITERAL_UNLIMITED_NATURAL__VALUE:
			return (T) (Integer) super.getValue();
		default:
	...
	@Override
	public int getValue() {
		return inheritFeature(UMLPackage.Literals.LITERAL_UNLIMITED_NATURAL__VALUE);
	}
	...
	public void unsetValue() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, UMLPackage.LITERAL_UNLIMITED_NATURAL__VALUE, oldValue, getValue(), oldValueESet));
		}
	}
