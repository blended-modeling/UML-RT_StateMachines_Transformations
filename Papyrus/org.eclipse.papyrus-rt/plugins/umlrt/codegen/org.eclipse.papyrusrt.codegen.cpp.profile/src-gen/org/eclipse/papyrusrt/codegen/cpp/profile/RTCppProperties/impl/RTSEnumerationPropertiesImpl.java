...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RTS Enumeration Properties</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrusrt.codegen.cpp.profile.RTCppProperties.impl.RTSEnumerationPropertiesImpl#isGenerateDescriptor <em>Generate Descriptor</em>}</li>
 *   <li>{@link org.eclipse.papyrusrt.codegen.cpp.profile.RTCppProperties.impl.RTSEnumerationPropertiesImpl#getBase_Enumeration <em>Base Enumeration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RTSEnumerationPropertiesImpl extends RTSClassifierPropertiesImpl implements RTSEnumerationProperties {
	/**
	 ...
	 * @generated
	 */
	protected RTSEnumerationPropertiesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RTCppPropertiesPackage.Literals.RTS_ENUMERATION_PROPERTIES;
	}
	...
	public void setGenerateDescriptor(boolean newGenerateDescriptor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RTCppPropertiesPackage.RTS_ENUMERATION_PROPERTIES__GENERATE_DESCRIPTOR, oldGenerateDescriptor, generateDescriptor));
	}
	...
	public Enumeration getBase_Enumeration() {
		if (base_Enumeration != null && base_Enumeration.eIsProxy()) {
			...
			if (base_Enumeration != oldBase_Enumeration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RTCppPropertiesPackage.RTS_ENUMERATION_PROPERTIES__BASE_ENUMERATION, oldBase_Enumeration, base_Enumeration));
			}
		}
	...
	public void setBase_Enumeration(Enumeration newBase_Enumeration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RTCppPropertiesPackage.RTS_ENUMERATION_PROPERTIES__BASE_ENUMERATION, oldBase_Enumeration, base_Enumeration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RTCppPropertiesPackage.RTS_ENUMERATION_PROPERTIES__GENERATE_DESCRIPTOR:
				return isGenerateDescriptor();
			case RTCppPropertiesPackage.RTS_ENUMERATION_PROPERTIES__BASE_ENUMERATION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RTSDescriptorProperties.class) {
			switch (derivedFeatureID) {
				case RTCppPropertiesPackage.RTS_ENUMERATION_PROPERTIES__GENERATE_DESCRIPTOR: return RTCppPropertiesPackage.RTS_DESCRIPTOR_PROPERTIES__GENERATE_DESCRIPTOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == RTSDescriptorProperties.class) {
			switch (baseFeatureID) {
				case RTCppPropertiesPackage.RTS_DESCRIPTOR_PROPERTIES__GENERATE_DESCRIPTOR: return RTCppPropertiesPackage.RTS_ENUMERATION_PROPERTIES__GENERATE_DESCRIPTOR;
				default: return -1;
			}
		}
