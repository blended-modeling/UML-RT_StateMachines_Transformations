...
public class ElementtypefilterAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ElementtypefilterSwitch<Adapter> modelSwitch =
		new ElementtypefilterSwitch<Adapter>() {
			@Override
			public Adapter caseParentMatcherFilter(ParentMatcherFilter object) {
				return createParentMatcherFilterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrusrt.umlrt.tooling.filter.elementtypefilter.ParentMatcherFilter <em>Parent Matcher Filter</em>}'.
	 * <!-- begin-user-doc -->
...
} //ElementtypefilterAdapterFactory
