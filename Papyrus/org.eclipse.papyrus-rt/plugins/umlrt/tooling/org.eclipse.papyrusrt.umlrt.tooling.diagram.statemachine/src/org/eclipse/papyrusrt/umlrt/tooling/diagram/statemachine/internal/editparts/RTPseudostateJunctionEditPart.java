...
/**
 * RT specialization of the junction edit part.
 */
public class RTPseudostateJunctionEditPart extends PseudostateJunctionEditPart implements IRTPseudostateEditPart {
	 ...
	 *            my notation view
	 */
	public RTPseudostateJunctionEditPart(View view) {
		super(view);
	}
