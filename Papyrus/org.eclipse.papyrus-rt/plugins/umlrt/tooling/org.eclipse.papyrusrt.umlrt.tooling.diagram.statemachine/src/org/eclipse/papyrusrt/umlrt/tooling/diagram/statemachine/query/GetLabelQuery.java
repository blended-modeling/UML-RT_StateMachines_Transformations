 ...
 *   
 *****************************************************************************/
package org.eclipse.papyrusrt.umlrt.tooling.diagram.statemachine.query;
...
import org.eclipse.papyrusrt.umlrt.tooling.diagram.statemachine.provider.RTStateMachineDiagramFilteredLabelProvider;

public class GetLabelQuery implements IJavaQuery2<Diagram, String> {
	
	private static final RTStateMachineDiagramFilteredLabelProvider DIAGRAM_LABEL_PROVIDER = new RTStateMachineDiagramFilteredLabelProvider();
