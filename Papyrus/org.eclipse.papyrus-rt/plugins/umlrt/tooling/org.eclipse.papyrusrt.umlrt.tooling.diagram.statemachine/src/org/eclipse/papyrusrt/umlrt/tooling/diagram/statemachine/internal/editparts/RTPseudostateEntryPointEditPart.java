...
/**
 * RT specialization of the entry-point edit part.
 */
public class RTPseudostateEntryPointEditPart extends CustomPseudostateEntryPointEditPart implements IRTPseudostateEditPart {
	 ...
	 *            my notation view
	 */
	public RTPseudostateEntryPointEditPart(View view) {
		super(view);
	}
