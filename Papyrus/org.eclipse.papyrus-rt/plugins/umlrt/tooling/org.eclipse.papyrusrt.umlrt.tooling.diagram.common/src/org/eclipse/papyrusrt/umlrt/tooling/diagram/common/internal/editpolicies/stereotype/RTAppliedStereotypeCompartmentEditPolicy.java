...
/**
 * Customization of the applied-stereotype compartment edit-policy that accounts for
 * inheritance of views from other diagrams by not creating the compartment views for
...
public class RTAppliedStereotypeCompartmentEditPolicy extends AppliedStereotypeCompartmentEditPolicy {
	...
	public RTAppliedStereotypeCompartmentEditPolicy() {
		super();
	}
