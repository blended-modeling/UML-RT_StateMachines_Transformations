...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>System Protocol</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrusrt.umlrt.system.profile.systemelements.impl.SystemProtocolImpl#getBase_Collaboration <em>Base Collaboration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemProtocolImpl extends MinimalEObjectImpl.Container implements SystemProtocol {
	/**
	...
	protected EClass eStaticClass() {
		return SystemElementsPackage.Literals.SYSTEM_PROTOCOL;
	}
		...
		if (base_Collaboration != null && base_Collaboration.eIsProxy()) {
			...
			if (base_Collaboration != oldBase_Collaboration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SystemElementsPackage.SYSTEM_PROTOCOL__BASE_COLLABORATION, oldBase_Collaboration, base_Collaboration));
			}
		}
	...
	public void setBase_Collaboration(Collaboration newBase_Collaboration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemElementsPackage.SYSTEM_PROTOCOL__BASE_COLLABORATION, oldBase_Collaboration, base_Collaboration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SystemElementsPackage.SYSTEM_PROTOCOL__BASE_COLLABORATION:
