...
/**
 * {@link IElementMatcher} for SPP Ports
 */
public class ServiceProvisionPointMatcher implements IElementMatcher {
	...
	public boolean matches(EObject eObject) {
		...
		// 1. isService = true. Will not be checked for compatibility reasons (Cf. Bug 477033)
		// 2. behavior = true
		// 3. isWired = false
		// 4. isPublish = true
		if (!port.isBehavior()) {
