...
@Data
class InvalidVariableValueException extends AExprEvaluatorException
{
	Scope scope
	
	override getMessage()
	'''Unable to evaluate variable '«(expr as Var).name.toText»' in scope context «scope.contextName.toText»'''
