...
@Data
class CycleDetectedException extends AExprEvaluatorException
{
	Scope scope

	override getMessage()
	'''A cycle was detected when attempting to evaluate variable '«(expr as Var).name.toText»' in scope context «scope.contextName.toText»'''
}
