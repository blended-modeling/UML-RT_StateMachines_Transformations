...
// An instance of an object of this type is used to access the RTS from capsule-instance code.
...
public:
    ...
    virtual const UMLRTCommsPort * createInternalPorts ( UMLRTSlot * slot, const UMLRTCapsuleClass * capsuleClass, size_t numPortRoles, const UMLRTCommsPortRole portRoles[] ) const;

    // The capsule is declaring the port as 'bound'. The port is not a relay port.
    virtual void bindPort ( const UMLRTCommsPort * * borderPorts, int portId, int index ) const;
    virtual void bindPort ( const UMLRTCommsPort * internalPorts, int portId, int index ) const;
    ...
    virtual void unbindPort ( const UMLRTCommsPort * * borderPorts, int portId, int index ) const;
    virtual void unbindPort ( const UMLRTCommsPort * internalPorts, int portId, int index ) const;
