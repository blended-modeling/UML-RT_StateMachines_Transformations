...
{
    UMLRTFrameService::connectPorts( &slot->parts[Capsule_Top::part_part2].slots[0]->ports[Capsule_Capsule::borderport_right], 0, &slot->parts[Capsule_Top::part_part1].slots[0]->ports[Capsule_Capsule::borderport_left], 0 );
    UMLRTFrameService::connectPorts( &slot->parts[Capsule_Top::part_part2].slots[0]->ports[Capsule_Capsule::borderport_left], 0, &slot->parts[Capsule_Top::part_part3].slots[0]->ports[Capsule_Capsule::borderport_right], 0 );
    UMLRTFrameService::connectPorts( &slot->parts[Capsule_Top::part_part4].slots[0]->ports[Capsule_Capsule::borderport_right], 0, &slot->parts[Capsule_Top::part_part3].slots[0]->ports[Capsule_Capsule::borderport_left], 0 );
    UMLRTFrameService::connectPorts( &slot->parts[Capsule_Top::part_part4].slots[0]->ports[Capsule_Capsule::borderport_left], 0, &slot->parts[Capsule_Top::part_part1].slots[0]->ports[Capsule_Capsule::borderport_right], 0 );
