...
UMLRTCommsPort internalports_Top_computer[] = 
{
    {
        &Computer,
...
static UMLRTCommsPortFarEnd borderfarEndList_Top_computer_pluginUsb_0[] =
{
    {
        3,
        &internalports_Top_computer[Capsule_Computer::internalport_inkPresent]
    },
    {
        3,
...
static UMLRTCommsPortFarEnd borderfarEndList_Top_computer_usbHub[] = 
{
        ...
        {
            0,
            &internalports_Top_computer[Capsule_Computer::internalport_staticPort]
        },
};
