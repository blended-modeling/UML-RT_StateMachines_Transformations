...
class QualifiedNames
{
    ...
    def String create
    {
        ...
        new String
        (
            (if (owner === null || !(owner instanceof NamedElement)) "" else cachedFullNameOf(owner as NamedElement) + SEPARATOR)
            + element.validName
        )
    }
    ...
    def String create
    {
        ...
        new String
        (
            (if (owner === null || owner instanceof StateMachine) "" else cachedFullSMNameOf(owner as NamedElement) + SEPARATOR)
            + element.validName
        )
    }
    ...
    def String fullNameOf( NamedElement element )
    {
        ...
        new String
        (
            (if (owner === null || !(owner instanceof NamedElement)) "" else fullNameOf(owner as NamedElement) + SEPARATOR) + element.validName
        )
    }
    ...
    def String fullSMNameOf( NamedElement element )
    {
        ...
        new String
        (
            (if (owner === null || owner instanceof StateMachine) "" else fullSMNameOf(owner as NamedElement) + SEPARATOR) + element.validName
        )
    }
